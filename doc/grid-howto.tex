...
The equation will be solved using P1-Finite-Elements on a simplical grid. The implementation aims to be easy to understand and yet show the power of the \Dune{} grid interface and its generic approach. \\

The starting point of the Finite Element Method is the variational formulation of which we obtain by partial integration:
...
We will not implement our Dirichlet boundary conditions into this function space. Instead we will implement them in a more direct manner as we can see later on. \\
...
\nopagebreak
\lstinputlisting[basicstyle=\ttfamily\scriptsize,numbers=left, 
numberstyle=\tiny, numbersep=5pt]{../finiteelements.cc}
\end{lst}
