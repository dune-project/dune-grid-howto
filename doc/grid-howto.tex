...
cube and \lstinline!H!  defines the extend of the cube in each space
dimension. Finally in line \ref{gs:grid} we are now able to
...
\end{center}
An Intersections is with another element $\omega_j$ if the
...
type \textit{interior} because only thos elements have all neighboring
