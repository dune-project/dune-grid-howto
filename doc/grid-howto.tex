...
\item \textit{Stuttgart Finite Element Hierarchy.} Another flexible
...
Now you can join the folks who have downloaded the Subversion repositories.

\minisec{From Subversion download} 

You have checked out two directories \lstinline!dune! and 
\lstinline!dune-grid-howto! from the Subversion server. If you have not done
